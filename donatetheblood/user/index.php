...
if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
	if (isset($_POST['date'])) {
		...
		<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Are you sure you want to update record?</strong>
				...
				<div class="panel panel-default" style="padding: 20px;">
					<div class="panel-body">
						...
						<div class="alert alert-danger alert-dismissable" style="font-size: 18px; display: none;">
							...
							<strong>Warning!</strong> Are you sure you want to donate blood if you press yes, then you will not be able to show before 3 months.
						...
						if ($saveDate == '0') {
							...
							<button type="submit" style="margin-top: 20px;" name="date" id="save_the_life" class="btn btn-lg btn-danger center-aligned ">Save Life</button>
							...
							<span>You have donated blood.You will be able to donate blood after 3 months! Thanks for your support.</span>
						</div>';
							}
						}
						?>
